...
extern const u8 EventScript_Refrigerator[];
extern const u8 EventScript_Radio[];
extern const u8 EventScript_Dresser[];
extern const u8 EventScript_FRLGTV[];
extern const u8 EventScript_Stove[];
extern const u8 EventScript_DishCupboard[];
extern const u8 EventScript_Machine[];
extern const u8 EventScript_Phone[];
extern const u8 EventScript_Computer[];
extern const u8 EventScript_Machine2[];
extern const u8 EventScript_Window[];
extern const u8 EventScript_Painting1[];
extern const u8 EventScript_Painting2[];

...
extern const u32 gMonFrontPic_OrangeBellsprout[];
extern const u32 gMonPalette_OrangeBellsprout[];
extern const u32 gMonBackPic_OrangeBellsprout[];
extern const u32 gMonShinyPalette_OrangeBellsprout[];
extern const u32 gMonStillFrontPic_OrangeBellsprout[];
extern const u8 gMonIcon_OrangeBellsprout[];
extern const u8 gMonFootprint_OrangeBellsprout[];

extern const u32 gMonFrontPic_OrangeWeepinbell[];
extern const u32 gMonPalette_OrangeWeepinbell[];
extern const u32 gMonBackPic_OrangeWeepinbell[];
extern const u32 gMonShinyPalette_OrangeWeepinbell[];
extern const u32 gMonStillFrontPic_OrangeWeepinbell[];
extern const u8 gMonIcon_OrangeWeepinbell[];
extern const u8 gMonFootprint_OrangeWeepinbell[];

extern const u32 gMonFrontPic_OrangeVictreebel[];
extern const u32 gMonPalette_OrangeVictreebel[];
extern const u32 gMonBackPic_OrangeVictreebel[];
extern const u32 gMonShinyPalette_OrangeVictreebel[];
extern const u32 gMonStillFrontPic_OrangeVictreebel[];
extern const u8 gMonIcon_OrangeVictreebel[];
extern const u8 gMonFootprint_OrangeVictreebel[];

extern const u32 gMonFrontPic_OrangeSentret[];
extern const u32 gMonPalette_OrangeSentret[];
extern const u32 gMonBackPic_OrangeSentret[];
extern const u32 gMonShinyPalette_OrangeSentret[];
extern const u32 gMonStillFrontPic_OrangeSentret[];
extern const u8 gMonIcon_OrangeSentret[];
extern const u8 gMonFootprint_OrangeSentret[];

extern const u32 gMonFrontPic_OrangeFurret[];
extern const u32 gMonPalette_OrangeFurret[];
extern const u32 gMonBackPic_OrangeFurret[];
extern const u32 gMonShinyPalette_OrangeFurret[];
extern const u32 gMonStillFrontPic_OrangeFurret[];
extern const u8 gMonIcon_OrangeFurret[];
extern const u8 gMonFootprint_OrangeFurret[];

extern const u32 gMonFrontPic_OrangeButterfree[];
extern const u32 gMonPalette_OrangeButterfree[];
extern const u32 gMonBackPic_OrangeButterfree[];
extern const u32 gMonShinyPalette_OrangeButterfree[];
extern const u32 gMonStillFrontPic_OrangeButterfree[];
extern const u8 gMonIcon_OrangeButterfree[];
extern const u8 gMonFootprint_OrangeButterfree[];

extern const u32 gMonFrontPic_OrangeWingull[];
extern const u32 gMonPalette_OrangeWingull[];
extern const u32 gMonBackPic_OrangeWingull[];
extern const u32 gMonShinyPalette_OrangeWingull[];
extern const u32 gMonStillFrontPic_OrangeWingull[];
extern const u8 gMonIcon_OrangeWingull[];
extern const u8 gMonFootprint_OrangeWingull[];

extern const u32 gMonFrontPic_OrangePelipper[];
extern const u32 gMonPalette_OrangePelipper[];
extern const u32 gMonBackPic_OrangePelipper[];
extern const u32 gMonShinyPalette_OrangePelipper[];
extern const u32 gMonStillFrontPic_OrangePelipper[];
extern const u8 gMonIcon_OrangePelipper[];
extern const u8 gMonFootprint_OrangePelipper[];

extern const u32 gMonFrontPic_OrangeVileplume[];
extern const u32 gMonPalette_OrangeVileplume[];
extern const u32 gMonBackPic_OrangeVileplume[];
extern const u32 gMonShinyPalette_OrangeVileplume[];
extern const u32 gMonStillFrontPic_OrangeVileplume[];
extern const u8 gMonIcon_OrangeVileplume[];
extern const u8 gMonFootprint_OrangeVileplume[];

extern const u32 gMonFrontPic_OrangeHoothoot[];
extern const u32 gMonPalette_OrangeHoothoot[];
extern const u32 gMonBackPic_OrangeHoothoot[];
extern const u32 gMonShinyPalette_OrangeHoothoot[];
extern const u32 gMonStillFrontPic_OrangeHoothoot[];
extern const u8 gMonIcon_OrangeHoothoot[];
extern const u8 gMonFootprint_OrangeHoothoot[];

extern const u32 gMonFrontPic_OrangeNoctowl[];
extern const u32 gMonPalette_OrangeNoctowl[];
extern const u32 gMonBackPic_OrangeNoctowl[];
extern const u32 gMonShinyPalette_OrangeNoctowl[];
extern const u32 gMonStillFrontPic_OrangeNoctowl[];
extern const u8 gMonIcon_OrangeNoctowl[];
extern const u8 gMonFootprint_OrangeNoctowl[];

extern const u32 gMonFrontPic_OrangeBellossom[];
extern const u32 gMonPalette_OrangeBellossom[];
extern const u32 gMonBackPic_OrangeBellossom[];
extern const u32 gMonShinyPalette_OrangeBellossom[];
extern const u32 gMonStillFrontPic_OrangeBellossom[];
extern const u8 gMonIcon_OrangeBellossom[];
extern const u8 gMonFootprint_OrangeBellossom[];

extern const u32 gMonFrontPic_OrangeGyarados[];
extern const u32 gMonPalette_OrangeGyarados[];
extern const u32 gMonBackPic_OrangeGyarados[];
extern const u32 gMonShinyPalette_OrangeGyarados[];
extern const u32 gMonStillFrontPic_OrangeGyarados[];
extern const u8 gMonIcon_OrangeGyarados[];
extern const u8 gMonFootprint_OrangeGyarados[];

extern const u32 gMonFrontPic_OrangeOnix[];
extern const u32 gMonPalette_OrangeOnix[];
extern const u32 gMonBackPic_OrangeOnix[];
extern const u32 gMonShinyPalette_OrangeOnix[];
extern const u32 gMonStillFrontPic_OrangeOnix[];
extern const u8 gMonIcon_OrangeOnix[];
extern const u8 gMonFootprint_OrangeOnix[];

extern const u32 gMonFrontPic_OrangeSteelix[];
extern const u32 gMonPalette_OrangeSteelix[];
extern const u32 gMonBackPic_OrangeSteelix[];
extern const u32 gMonShinyPalette_OrangeSteelix[];
extern const u32 gMonStillFrontPic_OrangeSteelix[];
extern const u8 gMonIcon_OrangeSteelix[];
extern const u8 gMonFootprint_OrangeSteelix[];
...
extern const u32 gTrainerPalette_Tracey[];

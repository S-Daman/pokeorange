...
bool8 MetatileBehavior_IsRefrigerator(u8);
bool8 MetatileBehavior_IsRadio(u8);
bool8 MetatileBehavior_IsDresser(u8);
bool8 MetatileBehavior_IsFRLGTV(u8);
bool8 MetatileBehavior_IsStove(u8);
bool8 MetatileBehavior_IsDishCupboard(u8);
bool8 MetatileBehavior_IsMachine(u8);
bool8 MetatileBehavior_IsPhone(u8);
bool8 MetatileBehavior_IsComputer(u8);
bool8 MetatileBehavior_IsMachine2(u8);
bool8 MetatileBehavior_IsWindow(u8);
bool8 MetatileBehavior_IsPainting1(u8);
bool8 MetatileBehavior_IsPainting2(u8);
bool8 MetatileBehavior_LazySandBG(u8);

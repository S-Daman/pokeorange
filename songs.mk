...
$(MID_SUBDIR)/mus_cora_encounter.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G155 -V0150

$(MID_SUBDIR)/mus_cora_battle.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G155 -V100
	
$(MID_SUBDIR)/mus_orange_trainer_battle.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G155 -V105
	
$(MID_SUBDIR)/mus_orange_wild_battle.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G155 -V110

$(MID_SUBDIR)/mus_orange_leaderbat.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G155 -V105

$(MID_SUBDIR)/mus_valencia.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G051 -V95

$(MID_SUBDIR)/mus_orange_lab.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G160 -V110

$(MID_SUBDIR)/mus_cherry.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G173 -v100
	
$(MID_SUBDIR)/mus_orange_routeone.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G155 -V0120

$(MID_SUBDIR)/mus_orange_routetwo.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G155 -V120
	
$(MID_SUBDIR)/mus_orange_title.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G155 -V120
	
$(MID_SUBDIR)/mus_orange_woods.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G155 -V100
	
$(MID_SUBDIR)/mus_orange_boy.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G155 -V100

$(MID_SUBDIR)/mus_orange_beauty.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G155 -V100

$(MID_SUBDIR)/mus_gfintro.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G180 -V170
	
$(MID_SUBDIR)/mus_dragonite.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G155 -V100
	
$(MID_SUBDIR)/mus_battle_johtotrainer.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G155 -V100

$(MID_SUBDIR)/mus_battle_johtogym.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G155 -V100
...
const u32 gMonFrontPic_OrangeBellsprout[] = INCBIN_U32("graphics/pokemon/orange_bellsprout/anim_front.4bpp.lz");
const u32 gMonFrontPic_OrangeWeepinbell[] = INCBIN_U32("graphics/pokemon/orange_weepinbell/anim_front.4bpp.lz");
const u32 gMonFrontPic_OrangeVictreebel[] = INCBIN_U32("graphics/pokemon/orange_victreebel/anim_front.4bpp.lz");

const u32 gMonFrontPic_OrangeSentret[] = INCBIN_U32("graphics/pokemon/orange_sentret/anim_front.4bpp.lz");
const u32 gMonFrontPic_OrangeFurret[] = INCBIN_U32("graphics/pokemon/orange_furret/anim_front.4bpp.lz");

const u32 gMonFrontPic_OrangeButterfree[] = INCBIN_U32("graphics/pokemon/orange_butterfree/anim_front.4bpp.lz");

const u32 gMonFrontPic_OrangeWingull[] = INCBIN_U32("graphics/pokemon/orange_wingull/anim_front.4bpp.lz");
const u32 gMonFrontPic_OrangePelipper[] = INCBIN_U32("graphics/pokemon/orange_pelipper/anim_front.4bpp.lz");

const u32 gMonFrontPic_OrangeVileplume[] = INCBIN_U32("graphics/pokemon/orange_vileplume/anim_front.4bpp.lz");

const u32 gMonFrontPic_OrangeHoothoot[] = INCBIN_U32("graphics/pokemon/orange_hoothoot/anim_front.4bpp.lz");
const u32 gMonFrontPic_OrangeNoctowl[] = INCBIN_U32("graphics/pokemon/orange_noctowl/anim_front.4bpp.lz");

const u32 gMonFrontPic_OrangeBellossom[] = INCBIN_U32("graphics/pokemon/orange_bellossom/anim_front.4bpp.lz");

const u32 gMonFrontPic_OrangeGyarados[] = INCBIN_U32("graphics/pokemon/orange_gyarados/anim_front.4bpp.lz");

const u32 gMonFrontPic_OrangeOnix[] = INCBIN_U32("graphics/pokemon/orange_onix/anim_front.4bpp.lz");
const u32 gMonFrontPic_OrangeSteelix[] = INCBIN_U32("graphics/pokemon/orange_steelix/anim_front.4bpp.lz");

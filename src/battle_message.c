...
static const u8 sText_WallyUsedItem[] = _("The TRAINER used\n{B_LAST_ITEM}!");
...
static const u8 sText_YouThrowABallNowRight[] = _("Now that the POKéMON is weakened,\nyou throw a POKé BALL!");
...
const u8 gText_BattleWallyName[] = _("TRAINER");

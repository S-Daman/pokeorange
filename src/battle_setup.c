...
{
    u16 monData;
    CreateMon(&gEnemyParty[0], SPECIES_SEEDOT, 5, 100, FALSE, 0, OT_ID_PLAYER_ID, 0);
    monData = TRUE;
...
u8 BattleSetup_GetTerrainId(void)
{
	...
	if (MetatileBehavior_LazySandBG(tileBehavior))
		return BATTLE_TERRAIN_SAND;
...
void SetUpTrainerEncounterMusic(void)
{
        ...
        && sTrainerBattleMode != TRAINER_BATTLE_CONTINUE_SCRIPT_DOUBLE_NO_MUSIC)
    {
        ...
        case TRAINER_ENCOUNTER_MUSIC_RICH:
            music = MUS_TEST;
            break;
        case TRAINER_ENCOUNTER_MUSIC_SWIMMER_GSC:
            music = MUS_RG_ROCKET;
            break;
        default:
            music = MUS_AYASII;

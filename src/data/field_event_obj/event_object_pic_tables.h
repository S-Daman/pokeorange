...
const struct SpriteFrameImage gEventObjectPicTable_Brawly[] = {
    ...
    overworld_frame(gEventObjectPic_Brawly, 2, 4, 3),
    overworld_frame(gEventObjectPic_Brawly, 2, 4, 4),
    overworld_frame(gEventObjectPic_Brawly, 2, 4, 5),
    overworld_frame(gEventObjectPic_Brawly, 2, 4, 6),
    overworld_frame(gEventObjectPic_Brawly, 2, 4, 7),
    overworld_frame(gEventObjectPic_Brawly, 2, 4, 8),
};

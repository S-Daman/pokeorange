const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_METAPOD]    = {{EVO_LEVEL, 10, SPECIES_ORANGE_BUTTERFREE}},
    ...
    [SPECIES_GLOOM]      = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ORANGE_VILEPLUME},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_ORANGE_BELLOSSOM}},
    ...
    [SPECIES_MAGIKARP]   = {{EVO_LEVEL, 20, SPECIES_ORANGE_GYARADOS}},
    ...
    [SPECIES_ORANGE_BELLSPROUT] = {{EVO_LEVEL, 21, SPECIES_ORANGE_WEEPINBELL}},
    [SPECIES_ORANGE_WEEPINBELL] = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_ORANGE_VICTREEBEL}},
    [SPECIES_ORANGE_SENTRET]    = {{EVO_LEVEL, 15, SPECIES_ORANGE_FURRET}},
    [SPECIES_ORANGE_HOOTHOOT]   = {{EVO_LEVEL, 20, SPECIES_ORANGE_NOCTOWL}},
    [SPECIES_ORANGE_WINGULL]    = {{EVO_LEVEL, 25, SPECIES_ORANGE_PELIPPER}},
    [SPECIES_ORANGE_ONIX]   = {{EVO_LEVEL, 30, SPECIES_ORANGE_STEELIX}},
};

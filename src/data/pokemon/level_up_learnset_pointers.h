const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_ORANGE_BUTTERFREE] = sOrangeButterfreeLevelUpLearnset,
    [SPECIES_ORANGE_VILEPLUME] = sOrangeVileplumeLevelUpLearnset,
    [SPECIES_ORANGE_BELLSPROUT] = sOrangeBellsproutLevelUpLearnset,
    [SPECIES_ORANGE_WEEPINBELL] = sOrangeWeepinbellLevelUpLearnset,
    [SPECIES_ORANGE_VICTREEBEL] = sOrangeVictreebelLevelUpLearnset,
	[SPECIES_ORANGE_GYARADOS] = sOrangeGyaradosLevelUpLearnset,
    [SPECIES_ORANGE_SENTRET] = sOrangeSentretLevelUpLearnset,
    [SPECIES_ORANGE_FURRET] = sOrangeFurretLevelUpLearnset,
    [SPECIES_ORANGE_HOOTHOOT] = sOrangeHoothootLevelUpLearnset,
    [SPECIES_ORANGE_NOCTOWL] = sOrangeNoctowlLevelUpLearnset,
	[SPECIES_ORANGE_BELLOSSOM] = sOrangeBellossomLevelUpLearnset,
    [SPECIES_ORANGE_WINGULL] = sOrangeWingullLevelUpLearnset,
    [SPECIES_ORANGE_PELIPPER] = sOrangePelipperLevelUpLearnset,
    [SPECIES_WEAK_LAPRAS] = sLaprasLevelUpLearnset,
    [SPECIES_ORANGE_ONIX] = sOrangeOnixLevelUpLearnset,
    [SPECIES_ORANGE_STEELIX] = sOrangeSteelixLevelUpLearnset,
};

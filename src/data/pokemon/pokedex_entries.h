const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_ORANGE_BUTTERFREE] =
    {
        .categoryName = _("BUTTERFLY"),
        .height = 11,
        .weight = 322,
        .description = gOrangeButterfreePokedexText,
        .pokemonScale = 312,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ORANGE_VILEPLUME] =
    {
        .categoryName = _("FLOWER"),
        .height = 12,
        .weight = 174,
        .description = gOrangeVileplumePokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ORANGE_BELLSPROUT] =
    {
        .categoryName = _("FLOWER"),
        .height = 10,
        .weight = 55,
        .description = gOrangeBellsproutPokedexText,
        .pokemonScale = 342,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ORANGE_WEEPINBELL] =
    {
        .categoryName = _("FLYCATCHER"),
        .height = 11,
        .weight = 96,
        .description = gOrangeWeepinbellPokedexText,
        .pokemonScale = 284,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ORANGE_VICTREEBEL] =
    {
        .categoryName = _("FLYCATCHER"),
        .height = 18,
        .weight = 190,
        .description = gOrangeVictreebelPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 300,
        .trainerOffset = 3,
    ...
    [NATIONAL_DEX_ORANGE_ONIX] =
    {
        .categoryName = _("CRYSTAL"),
        .height = 85,
        .weight = 1750,
        .description = gOrangeOnixPokedexText,
        .pokemonScale = 245,
        .pokemonOffset = 1,
        .trainerScale = 515,
        .trainerOffset = 14,
    ...
    [NATIONAL_DEX_ORANGE_GYARADOS] =
    {
        .categoryName = _("SEA MONSTER"),
        .height = 72,
        .weight = 2200,
        .description = gOrangeGyaradosPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 452,
        .trainerOffset = 13,
    ...
    [NATIONAL_DEX_ORANGE_SENTRET] =
    {
        .categoryName = _("MUSCLEHEAD"),
        .height = 10,
        .weight = 353,
        .description = gOrangeSentretPokedexText,
        .pokemonScale = 300,
        .pokemonOffset = 6,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ORANGE_FURRET] =
    {
        .categoryName = _("RUFFIAN"),
        .height = 19,
        .weight = 897,
        .description = gOrangeFurretPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 280,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ORANGE_HOOTHOOT] =
    {
        .categoryName = _("OWL"),
        .height = 7,
        .weight = 200,
        .description = gOrangeHoothootPokedexText,
        .pokemonScale = 370,
        .pokemonOffset = -2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ORANGE_NOCTOWL] =
    {
        .categoryName = _("OWL"),
        .height = 16,
        .weight = 230,
        .description = gOrangeNoctowlPokedexText,
        .pokemonScale = 260,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ORANGE_BELLOSSOM] =
    {
        .categoryName = _("HARVEST"),
        .height = 5,
        .weight = 64,
        .description = gOrangeBellossomPokedexText,
        .pokemonScale = 408,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ORANGE_STEELIX] =
    {
        .categoryName = _("CRYSTAL"),
        .height = 87,
        .weight = 3500,
        .description = gOrangeSteelixPokedexText,
        .pokemonScale = 245,
        .pokemonOffset = 0,
        .trainerScale = 516,
        .trainerOffset = 13,
    ...
    [NATIONAL_DEX_ORANGE_WINGULL] =
    {
        .categoryName = _("PIRATE"),
        .height = 7,
        .weight = 111,
        .description = gOrangeWingullPokedexText,
        .pokemonScale = 275,
        .pokemonOffset = -2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ORANGE_PELIPPER] =
    {
        .categoryName = _("BUCCANEER"),
        .height = 13,
        .weight = 310,
        .description = gOrangePelipperPokedexText,
        .pokemonScale = 270,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,

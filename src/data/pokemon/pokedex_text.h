...
const u8 gOrangeButterfreePokedexText[] = _(
    "Its large wings capture spiritual energy\n"
    "from nature. By flapping its wings, it\n"
    "scatters a soothing dust, which can cause\n"
    "a state of trance upon contact.");
	
const u8 gOrangeVileplumePokedexText[] = _(
    "When irritated, VILEPLUME oooze highly\n"
    "flammable liquids which stick to the\n"
    "surroundings and ignite. This has been\n"
    "a common cause for forest fires.");
	
const u8 gOrangeBellossomPokedexText[] = _(
    "BELLOSSOM thrive in floodplain areas\n"
    "since the nutrient-rich soil nourishes the\n"
    "crops on their body. When their leaves dry\n"
    "and fall off, they make great fertilizers.");	
	
const u8 gOrangeBellsproutPokedexText[] = _(
    " A BELLSPROUT uses its stem to convert the\n"
    "energy obtained from photosynthesis into\n"
    "electrical waves. The stem also serves\n"
    "as a lightning rod during thunderstorms.");

const u8 gOrangeWeepinbellPokedexText[] = _(
    "WEEPINBELL seek pleasure in shocking\n"
    "POKéMON after luring them out by emitting\n"
    "light from their bulb, especially when it\n"
    "is in dark environments.");

const u8 gOrangeVictreebelPokedexText[] = _(
    "The light emitted from its bulb is so\n"
    "concentrated that it blinds the prey. Once\n"
    "blinded, it engulfs the prey, electrocutes\n"
    "it, and then slowly devours it.");	
	
const u8 gOrangeSentretPokedexText[] = _(
    "SENTRET love bulking up on berries and\n"
    "working out for more than 18 hours a day.\n"
    "They can often be seen wrestling with each\n"
    "other as part of their excercise regimen.");	
	
const u8 gOrangeFurretPokedexText[] = _(
    "It was restrained by a shackle around its\n"
    "neck for being too violent from the stress\n"
    "of evolution. However, it easily broke the\n"
    "the shackle off and escaped into the wild.");	
	
const u8 gOrangeWingullPokedexText[] = _(
    "WINGULL are notorious for stealing food\n"
    "from people and other POKéMON. They are\n"
    "known to be quite spiteful, and often\n"
    "even defecate on innocent bystanders.");	
	
const u8 gOrangePelipperPokedexText[] = _(
    "They form gangs of WINGULL by bullying\n"
    "them into working for them. These gangs\n"
    "compete with each other for territory and\n"
    "forage. They show no mercy to traitors.");

const u8 gOrangeHoothootPokedexText[] = _(
    "A HOOTHOOT communicates with many spirits\n"
    "while maintaining a constant state of\n"
    "meditation. When it sees foul spirits, it is\n"
    "seldom sent into neverending nightmares.");		

const u8 gOrangeNoctowlPokedexText[] = _(
    "This POKéMON is viewed as a harbringer of\n"
    "bad luck and ill health. It is known to\n"
    "have close ties with DUSKULL, helping them\n"
    "with spiriting away misbehaved children.");

const u8 gOrangeGyaradosPokedexText[] = _(
    "Its barbels have the ability to control\n"
    "the ocean tides. When enraged, it causes\n"
    "violent tempests, wreaking large-scale\n"
    "havoc and even submerging whole islands.");
	
const u8 gOrangeOnixPokedexText[] = _(
    "This POKéMON's cold crystalline body was\n"
    "formed from a mutation when it was digging\n"
    "tunnels under the south pole. It prefers\n"
    "living in cool waters, and can't stand heat.");
	
const u8 gOrangeSteelixPokedexText[] = _(
    "Despite its intimidating appearance, it\n"
    "is actually a very harmonious POKéMON.\n"
    "When light hits STEELIX's body, it bursts\n"
    "into a dazzling display of rainbows.");
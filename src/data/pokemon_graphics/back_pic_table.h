const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(ORANGE_BUTTERFREE, gMonBackPic_OrangeButterfree),
    SPECIES_SPRITE(ORANGE_VILEPLUME, gMonBackPic_OrangeVileplume),
    SPECIES_SPRITE(ORANGE_BELLSPROUT, gMonBackPic_OrangeBellsprout),
    SPECIES_SPRITE(ORANGE_WEEPINBELL, gMonBackPic_OrangeWeepinbell),
    SPECIES_SPRITE(ORANGE_VICTREEBEL, gMonBackPic_OrangeVictreebel),
	SPECIES_SPRITE(ORANGE_GYARADOS, gMonBackPic_OrangeGyarados),
    SPECIES_SPRITE(ORANGE_SENTRET, gMonBackPic_OrangeSentret),
    SPECIES_SPRITE(ORANGE_FURRET, gMonBackPic_OrangeFurret),
    SPECIES_SPRITE(ORANGE_HOOTHOOT, gMonBackPic_OrangeHoothoot),
    SPECIES_SPRITE(ORANGE_NOCTOWL, gMonBackPic_OrangeNoctowl),
    SPECIES_SPRITE(ORANGE_BELLOSSOM, gMonBackPic_OrangeBellossom),
    SPECIES_SPRITE(ORANGE_WINGULL, gMonBackPic_OrangeWingull),
    SPECIES_SPRITE(ORANGE_PELIPPER, gMonBackPic_OrangePelipper),
    SPECIES_SPRITE(WEAK_LAPRAS, gMonBackPic_Lapras),
    SPECIES_SPRITE(ORANGE_ONIX, gMonBackPic_OrangeOnix),
    SPECIES_SPRITE(ORANGE_STEELIX, gMonBackPic_OrangeSteelix),
};

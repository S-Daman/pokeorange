const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_ORANGE_BUTTERFREE] = gMonFootprint_OrangeButterfree,
    [SPECIES_ORANGE_VILEPLUME] = gMonFootprint_OrangeVileplume,
    [SPECIES_ORANGE_BELLSPROUT] = gMonFootprint_OrangeBellsprout,
    [SPECIES_ORANGE_WEEPINBELL] = gMonFootprint_OrangeWeepinbell,
    [SPECIES_ORANGE_VICTREEBEL] = gMonFootprint_OrangeVictreebel,
	[SPECIES_ORANGE_GYARADOS] = gMonFootprint_OrangeGyarados,
    [SPECIES_ORANGE_SENTRET] = gMonFootprint_OrangeSentret,
    [SPECIES_ORANGE_FURRET] = gMonFootprint_OrangeFurret,
    [SPECIES_ORANGE_HOOTHOOT] = gMonFootprint_OrangeHoothoot,
    [SPECIES_ORANGE_NOCTOWL] = gMonFootprint_OrangeNoctowl,
	[SPECIES_ORANGE_BELLOSSOM] = gMonFootprint_OrangeBellossom,
    [SPECIES_ORANGE_WINGULL] = gMonFootprint_OrangeWingull,
    [SPECIES_ORANGE_PELIPPER] = gMonFootprint_OrangePelipper,
    [SPECIES_WEAK_LAPRAS] = gMonFootprint_Lapras,
    [SPECIES_ORANGE_ONIX] = gMonFootprint_OrangeOnix,
    [SPECIES_ORANGE_STEELIX] = gMonFootprint_OrangeSteelix,
};

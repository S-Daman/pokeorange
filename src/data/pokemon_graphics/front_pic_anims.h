...
static const union AnimCmd *const sAnims_ORANGE_BUTTERFREE[] ={
    sAnim_GeneralFrame0,
    sAnim_BUTTERFREE_1,
};

static const union AnimCmd *const sAnims_ORANGE_VILEPLUME[] ={
    sAnim_GeneralFrame0,
    sAnim_VILEPLUME_1,
};

static const union AnimCmd *const sAnims_ORANGE_BELLSPROUT[] ={
    sAnim_GeneralFrame0,
    sAnim_BELLSPROUT_1,
};

static const union AnimCmd *const sAnims_ORANGE_WEEPINBELL[] ={
    sAnim_GeneralFrame0,
    sAnim_WEEPINBELL_1,
};

static const union AnimCmd *const sAnims_ORANGE_VICTREEBEL[] ={
    sAnim_GeneralFrame0,
    sAnim_VICTREEBEL_1,
};

static const union AnimCmd *const sAnims_ORANGE_GYARADOS[] ={
    sAnim_GeneralFrame0,
    sAnim_GYARADOS_1,
};

static const union AnimCmd *const sAnims_ORANGE_SENTRET[] ={
    sAnim_GeneralFrame0,
    sAnim_SENTRET_1,
};

static const union AnimCmd *const sAnims_ORANGE_FURRET[] ={
    sAnim_GeneralFrame0,
    sAnim_FURRET_1,
};

static const union AnimCmd *const sAnims_ORANGE_HOOTHOOT[] ={
    sAnim_GeneralFrame0,
    sAnim_HOOTHOOT_1,
};

static const union AnimCmd *const sAnims_ORANGE_NOCTOWL[] ={
    sAnim_GeneralFrame0,
    sAnim_NOCTOWL_1,
};

static const union AnimCmd *const sAnims_ORANGE_BELLOSSOM[] ={
    sAnim_GeneralFrame0,
    sAnim_BELLOSSOM_1,
};

static const union AnimCmd *const sAnims_ORANGE_WINGULL[] ={
    sAnim_GeneralFrame0,
    sAnim_WINGULL_1,
};

static const union AnimCmd *const sAnims_ORANGE_PELIPPER[] ={
    sAnim_GeneralFrame0,
    sAnim_PELIPPER_1,
};

static const union AnimCmd *const sAnims_ORANGE_ONIX[] ={
    sAnim_GeneralFrame0,
    sAnim_ONIX_1,
};

static const union AnimCmd *const sAnims_ORANGE_STEELIX[] ={
    sAnim_GeneralFrame0,
    sAnim_STEELIX_1,
};
...
const union AnimCmd *const *const gMonFrontAnimsPtrTable[] =
{
    ...
    ANIM_CMD(ORANGE_BUTTERFREE),
    ANIM_CMD(ORANGE_VILEPLUME),
    ANIM_CMD(ORANGE_BELLSPROUT),
    ANIM_CMD(ORANGE_WEEPINBELL),
    ANIM_CMD(ORANGE_VICTREEBEL),
	ANIM_CMD(ORANGE_GYARADOS),
    ANIM_CMD(ORANGE_SENTRET),
    ANIM_CMD(ORANGE_FURRET),
    ANIM_CMD(ORANGE_HOOTHOOT),
    ANIM_CMD(ORANGE_NOCTOWL),
	ANIM_CMD(ORANGE_BELLOSSOM),
    ANIM_CMD(ORANGE_WINGULL),
    ANIM_CMD(ORANGE_PELIPPER),
    ANIM_CMD_FULL(WEAK_LAPRAS, sAnims_LAPRAS),
	ANIM_CMD(ORANGE_ONIX),
	ANIM_CMD(ORANGE_STEELIX),
};

const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(ORANGE_BUTTERFREE, gMonFrontPic_OrangeButterfree),
    SPECIES_SPRITE(ORANGE_VILEPLUME, gMonFrontPic_OrangeVileplume),
    SPECIES_SPRITE(ORANGE_BELLSPROUT, gMonFrontPic_OrangeBellsprout),
    SPECIES_SPRITE(ORANGE_WEEPINBELL, gMonFrontPic_OrangeWeepinbell),
    SPECIES_SPRITE(ORANGE_VICTREEBEL, gMonFrontPic_OrangeVictreebel),
	SPECIES_SPRITE(ORANGE_GYARADOS, gMonFrontPic_OrangeGyarados),
    SPECIES_SPRITE(ORANGE_SENTRET, gMonFrontPic_OrangeSentret),
    SPECIES_SPRITE(ORANGE_FURRET, gMonFrontPic_OrangeFurret),
    SPECIES_SPRITE(ORANGE_HOOTHOOT, gMonFrontPic_OrangeHoothoot),
    SPECIES_SPRITE(ORANGE_NOCTOWL, gMonFrontPic_OrangeNoctowl),
	SPECIES_SPRITE(ORANGE_BELLOSSOM, gMonFrontPic_OrangeBellossom),
    SPECIES_SPRITE(ORANGE_WINGULL, gMonFrontPic_OrangeWingull),
    SPECIES_SPRITE(ORANGE_PELIPPER, gMonFrontPic_OrangePelipper),
    SPECIES_SPRITE(WEAK_LAPRAS, gMonFrontPic_Lapras),
    SPECIES_SPRITE(ORANGE_ONIX, gMonFrontPic_OrangeOnix),
    SPECIES_SPRITE(ORANGE_STEELIX, gMonFrontPic_OrangeSteelix),
};

const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(ORANGE_BUTTERFREE, gMonPalette_OrangeButterfree),
    SPECIES_PAL(ORANGE_VILEPLUME, gMonPalette_OrangeVileplume),
    SPECIES_PAL(ORANGE_BELLSPROUT, gMonPalette_OrangeBellsprout),
    SPECIES_PAL(ORANGE_WEEPINBELL, gMonPalette_OrangeWeepinbell),
    SPECIES_PAL(ORANGE_VICTREEBEL, gMonPalette_OrangeVictreebel),
	SPECIES_PAL(ORANGE_GYARADOS, gMonPalette_OrangeGyarados),
    SPECIES_PAL(ORANGE_SENTRET, gMonPalette_OrangeSentret),
    SPECIES_PAL(ORANGE_FURRET, gMonPalette_OrangeFurret),
    SPECIES_PAL(ORANGE_HOOTHOOT, gMonPalette_OrangeHoothoot),
    SPECIES_PAL(ORANGE_NOCTOWL, gMonPalette_OrangeNoctowl),
	SPECIES_PAL(ORANGE_BELLOSSOM, gMonPalette_OrangeBellossom),
    SPECIES_PAL(ORANGE_WINGULL, gMonPalette_OrangeWingull),
    SPECIES_PAL(ORANGE_PELIPPER, gMonPalette_OrangePelipper),
    SPECIES_PAL(WEAK_LAPRAS, gMonPalette_Lapras),
	SPECIES_PAL(ORANGE_ONIX, gMonPalette_OrangeOnix),
	SPECIES_PAL(ORANGE_STEELIX, gMonPalette_OrangeSteelix),
};

const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(ORANGE_BUTTERFREE, gMonShinyPalette_OrangeButterfree),
    SPECIES_SHINY_PAL(ORANGE_VILEPLUME, gMonShinyPalette_OrangeVileplume),
    SPECIES_SHINY_PAL(ORANGE_BELLSPROUT, gMonShinyPalette_OrangeBellsprout),
    SPECIES_SHINY_PAL(ORANGE_WEEPINBELL, gMonShinyPalette_OrangeWeepinbell),
    SPECIES_SHINY_PAL(ORANGE_VICTREEBEL, gMonShinyPalette_OrangeVictreebel),
	SPECIES_SHINY_PAL(ORANGE_GYARADOS, gMonShinyPalette_OrangeGyarados),
    SPECIES_SHINY_PAL(ORANGE_SENTRET, gMonShinyPalette_OrangeSentret),
    SPECIES_SHINY_PAL(ORANGE_FURRET, gMonShinyPalette_OrangeFurret),
    SPECIES_SHINY_PAL(ORANGE_HOOTHOOT, gMonShinyPalette_OrangeHoothoot),
    SPECIES_SHINY_PAL(ORANGE_NOCTOWL, gMonShinyPalette_OrangeNoctowl),
	SPECIES_SHINY_PAL(ORANGE_BELLOSSOM, gMonShinyPalette_OrangeBellossom),
    SPECIES_SHINY_PAL(ORANGE_WINGULL, gMonShinyPalette_OrangeWingull),
    SPECIES_SHINY_PAL(ORANGE_PELIPPER, gMonShinyPalette_OrangePelipper),
    SPECIES_SHINY_PAL(WEAK_LAPRAS, gMonShinyPalette_Lapras),
    SPECIES_SHINY_PAL(ORANGE_ONIX, gMonShinyPalette_OrangeOnix),
    SPECIES_SHINY_PAL(ORANGE_STEELIX, gMonShinyPalette_OrangeSteelix),
};

...
// Gen III
    ...
    SPECIES_SPRITE(ORANGE_BUTTERFREE, gMonStillFrontPic_OrangeButterfree),
    SPECIES_SPRITE(ORANGE_VILEPLUME, gMonStillFrontPic_OrangeVileplume),
    SPECIES_SPRITE(ORANGE_BELLSPROUT, gMonStillFrontPic_OrangeBellsprout),
    SPECIES_SPRITE(ORANGE_WEEPINBELL, gMonStillFrontPic_OrangeWeepinbell),
    SPECIES_SPRITE(ORANGE_VICTREEBEL, gMonStillFrontPic_OrangeVictreebel),
	SPECIES_SPRITE(ORANGE_GYARADOS, gMonStillFrontPic_OrangeGyarados),
    SPECIES_SPRITE(ORANGE_SENTRET, gMonStillFrontPic_OrangeSentret),
    SPECIES_SPRITE(ORANGE_FURRET, gMonStillFrontPic_OrangeFurret),
    SPECIES_SPRITE(ORANGE_HOOTHOOT, gMonStillFrontPic_OrangeHoothoot),
    SPECIES_SPRITE(ORANGE_NOCTOWL, gMonStillFrontPic_OrangeNoctowl),
	SPECIES_SPRITE(ORANGE_BELLOSSOM, gMonStillFrontPic_OrangeBellossom),
    SPECIES_SPRITE(ORANGE_WINGULL, gMonStillFrontPic_OrangeWingull),
    SPECIES_SPRITE(ORANGE_PELIPPER, gMonStillFrontPic_OrangePelipper),
    SPECIES_SPRITE(WEAK_LAPRAS, gMonStillFrontPic_Lapras),
	SPECIES_SPRITE(ORANGE_ONIX, gMonStillFrontPic_OrangeOnix),
	SPECIES_SPRITE(ORANGE_STEELIX, gMonStillFrontPic_OrangeSteelix),
};

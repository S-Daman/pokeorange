const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_ORANGE_BUTTERFREE] = _("BUTTERFREE"),
    [SPECIES_ORANGE_VILEPLUME] = _("VILEPLUME"),
    [SPECIES_ORANGE_BELLSPROUT] = _("BELLSPROUT"),
    [SPECIES_ORANGE_WEEPINBELL] = _("WEEPINBELL"),
    [SPECIES_ORANGE_VICTREEBEL] = _("VICTREEBEL"),
	[SPECIES_ORANGE_GYARADOS] = _("GYARADOS"),
    [SPECIES_ORANGE_SENTRET] = _("SENTRET"),
    [SPECIES_ORANGE_FURRET] = _("FURRET"),
    [SPECIES_ORANGE_HOOTHOOT] = _("HOOTHOOT"),
    [SPECIES_ORANGE_NOCTOWL] = _("NOCTOWL"),
	[SPECIES_ORANGE_BELLOSSOM] = _("BELLOSSOM"),
    [SPECIES_ORANGE_WINGULL] = _("WINGULL"),
    [SPECIES_ORANGE_PELIPPER] = _("PELIPPER"),
    [SPECIES_WEAK_LAPRAS] = _("LAPRAS"),
	[SPECIES_ORANGE_ONIX] = _("ONIX"),
	[SPECIES_ORANGE_STEELIX] = _("STEELIX"),
};

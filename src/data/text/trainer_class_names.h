const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_COLLECTOR] = _("SUPER NERD"),
    ...
    [TRAINER_CLASS_AQUA_LEADER] = _("KANTO LEADER"),
    ...
    [TRAINER_CLASS_MAGMA_ADMIN] = _("ROCKET ADMIN"),

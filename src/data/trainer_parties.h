...
static const struct TrainerMonNoItemDefaultMoves sParty_Dominik[] = {
    ...
    .iv = 0,
    .lvl = 10,
    .species = SPECIES_ORANGE_WINGULL,
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .species = SPECIES_HORSEA,
    .heldItem = ITEM_NONE,
    .moves = MOVE_BUBBLE, MOVE_SMOKESCREEN, MOVE_WATER_GUN, MOVE_WATER_PULSE
    },
    {
    .iv = 100,
    .lvl = 12,
    .species = SPECIES_CORPHISH,
    .heldItem = ITEM_NONE,
    .moves = MOVE_BUBBLE, MOVE_LEER, MOVE_VICE_GRIP, MOVE_WATER_PULSE
    },
    {
    .iv = 200,
    .lvl = 14,
    ...
    .moves = MOVE_BUBBLE, MOVE_HARDEN, MOVE_ROCK_TOMB, MOVE_WATER_PULSE
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Calvin1[] = {
    ...
    .iv = 0,
    .lvl = 4,
    .species = SPECIES_ORANGE_SENTRET,
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Tiana[] = {
    ...
    .iv = 0,
    .lvl = 4,
    .species = SPECIES_ORANGE_BELLSPROUT,
    }
};

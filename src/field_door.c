...
const u8 DoorAnimPalettes_8496FDC[] = {5, 5, 5, 5, 5, 5, 5, 5}; // door 00
const u8 DoorAnimPalettes_8496FE4[] = {3, 3, 3, 3, 3, 3, 3, 3}; // door 01
const u8 DoorAnimPalettes_8496FEC[] = {3, 3, 3, 3, 3, 3, 3, 3}; // door 02
const u8 DoorAnimPalettes_8496FF4[] = {7, 7, 7, 7, 7, 7, 7, 7}; // door 03
const u8 DoorAnimPalettes_8496FFC[] = {9, 9, 9, 9, 9, 9, 9, 9}; // door 04
const u8 DoorAnimPalettes_8497004[] = {11, 11, 11, 11, 11, 11, 11, 11};// door 05
const u8 DoorAnimPalettes_849700C[] = {6, 6, 6, 6, 6, 6, 6, 6}; // door 06
...
{
    {0x05D, 0, 1, DoorAnimTiles_00, DoorAnimPalettes_8496FDC}, // door 00
    {0x062, 1, 1, DoorAnimTiles_01, DoorAnimPalettes_8496FE4}, // door 01
    {0x1CB, 1, 1, DoorAnimTiles_02, DoorAnimPalettes_8496FEC}, // door 02
    {0x25B, 1, 1, DoorAnimTiles_03, DoorAnimPalettes_8496FF4}, // door 03
    {0x214, 0, 1, DoorAnimTiles_04, DoorAnimPalettes_8496FFC}, // door 04
    {0x23B, 0, 1, DoorAnimTiles_05, DoorAnimPalettes_8497004}, // door 05
    {0x217, 0, 1, DoorAnimTiles_06, DoorAnimPalettes_849700C}, // door 06

...
static void DrawBosda(void);
static void VBCB_FieldUpdateRegionMap(void);
static void Bosda_MCB2_FieldUpdateRegionMap(void);
static void Bosda_VBCB_FieldUpdateRegionMap(void);
static void MCB2_FieldUpdateRegionMap(void);
static void FieldUpdateRegionMap(void);
static void Bosda_FieldUpdateRegionMap(void);
...
void Bosda(MainCallback callback)
{
	//PlaySE(SE_SELECT);
    SetVBlankCallback(NULL);
    sFieldRegionMapHandler = malloc(sizeof(*sFieldRegionMapHandler));
...
static void DrawBosda(void)
{
    ...
    LoadUserWindowBorderGfx(0, 0x27, 0xd0);
    clear_scheduled_bg_copies_to_vram();
    SetMainCallback2(Bosda_MCB2_FieldUpdateRegionMap);
    SetVBlankCallback(Bosda_VBCB_FieldUpdateRegionMap);
}
...
static void FieldUpdateRegionMap(void)
{
    ...
    switch (sFieldRegionMapHandler->state)
    {
        ...
        case 1:
            ...
            offset = GetStringCenterAlignXOffset(1, gText_Hoenn, 0x28);
...
static void Bosda_FieldUpdateRegionMap(void)
{
    ...
    {
        case 0:
            Bosda_InitRegionMap(&sFieldRegionMapHandler->regionMap, 0);
            CreateRegionMapPlayerIcon(0, 0);
            CreateRegionMapCursor(1, 1);
            sFieldRegionMapHandler->state++;
            break;

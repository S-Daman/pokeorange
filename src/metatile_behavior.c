...
static const u8 sTileBitAttributes[] =
{
    ...
    [MB_PAINTING1] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_PAINTING2] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
	...
	[MB_REFRIGERATOR] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
	[MB_RADIO] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
	[MB_DRESSER] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
	[MB_FRLGTV] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
};
...
bool8 MetatileBehavior_LazySandBG(u8 metatileBehavior)
{
    if (metatileBehavior == MB_UNUSED_1F)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsRefrigerator(u8 metatileBehavior)
{
    if (metatileBehavior == MB_REFRIGERATOR)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsFRLGTV(u8 metatileBehavior)
{
    if (metatileBehavior == MB_FRLGTV)
        return TRUE;
    else
        return FALSE;
}

bool8 MetatileBehavior_IsStove(u8 metatileBehavior)
{
    if (metatileBehavior == MB_STOVE)
        return TRUE;
    else
        return FALSE;
}

bool8 MetatileBehavior_IsDishCupboard(u8 metatileBehavior)
{
    if (metatileBehavior == MB_DISHCUPBOARD)
        return TRUE;
    else
        return FALSE;
}

bool8 MetatileBehavior_IsMachine(u8 metatileBehavior)
{
    if (metatileBehavior == MB_MACHINE)
        return TRUE;
    else
        return FALSE;
}

bool8 MetatileBehavior_IsPhone(u8 metatileBehavior)
{
    if (metatileBehavior == MB_PHONE)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsMachine2(u8 metatileBehavior)
{
    if (metatileBehavior == MB_MACHINE2)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsPainting1(u8 metatileBehavior)
{
    if (metatileBehavior == MB_PAINTING1)
        return TRUE;
    else
        return FALSE;
}

bool8 MetatileBehavior_IsPainting2(u8 metatileBehavior)
{
    if (metatileBehavior == MB_PAINTING2)
        return TRUE;
    else
        return FALSE;
}

...
#define REGIONAL_SPECIES_TO_NATIONAL(region, name) [SPECIES_##region##_##name - 1] = NATIONAL_DEX_##name
...
const u16 gSpeciesToHoennPokedexNum[] = // Assigns all species to the Hoenn Dex Index (Summary No. for Hoenn Dex)
{
    ...
    SPECIES_TO_HOENN(ORANGE_BUTTERFREE),
    SPECIES_TO_HOENN(ORANGE_VILEPLUME),
    SPECIES_TO_HOENN(ORANGE_BELLSPROUT),
    SPECIES_TO_HOENN(ORANGE_WEEPINBELL),
    SPECIES_TO_HOENN(ORANGE_VICTREEBEL),
    SPECIES_TO_HOENN(ORANGE_ONIX),
    SPECIES_TO_HOENN(ORANGE_GYARADOS),
    SPECIES_TO_HOENN(ORANGE_SENTRET),
    SPECIES_TO_HOENN(ORANGE_FURRET),
    SPECIES_TO_HOENN(ORANGE_HOOTHOOT),
    SPECIES_TO_HOENN(ORANGE_NOCTOWL),
	SPECIES_TO_HOENN(ORANGE_BELLOSSOM),
    SPECIES_TO_HOENN(ORANGE_GIRAFARIG),
    SPECIES_TO_HOENN(ORANGE_DUNSPARCE),
    SPECIES_TO_HOENN(ORANGE_STEELIX),
    SPECIES_TO_HOENN(ORANGE_WINGULL),
    SPECIES_TO_HOENN(ORANGE_PELIPPER),
    SPECIES_TO_HOENN(ORANGE_VOLBEAT),
    SPECIES_TO_HOENN(ORANGE_ILLUMISE),
    SPECIES_TO_HOENN(ORANGE_TORKOAL),
    SPECIES_TO_HOENN(ORANGE_TROPIUS),
    SPECIES_TO_HOENN(ORANGE_ABSOL),
    SPECIES_TO_HOENN(WEAK_LAPRAS),
};
...
const u16 gSpeciesToNationalPokedexNum[] = // Assigns all species to the National Dex Index (Summary No. for National Dex)
{
    ...
    SPECIES_TO_NATIONAL(ORANGE_BUTTERFREE),
    SPECIES_TO_NATIONAL(ORANGE_VILEPLUME),
    SPECIES_TO_NATIONAL(ORANGE_BELLSPROUT),
    SPECIES_TO_NATIONAL(ORANGE_WEEPINBELL),
    SPECIES_TO_NATIONAL(ORANGE_VICTREEBEL),
	SPECIES_TO_NATIONAL(ORANGE_GYARADOS),
    SPECIES_TO_NATIONAL(ORANGE_SENTRET),
    SPECIES_TO_NATIONAL(ORANGE_FURRET),
    SPECIES_TO_NATIONAL(ORANGE_HOOTHOOT),
    SPECIES_TO_NATIONAL(ORANGE_NOCTOWL),
	SPECIES_TO_NATIONAL(ORANGE_BELLOSSOM),
    SPECIES_TO_NATIONAL(ORANGE_WINGULL),
    SPECIES_TO_NATIONAL(ORANGE_PELIPPER),
    SPECIES_TO_NATIONAL(WEAK_LAPRAS),
	SPECIES_TO_NATIONAL(ORANGE_ONIX),
	SPECIES_TO_NATIONAL(ORANGE_STEELIX),
};
...
const u16 gHoennToNationalOrder[] = // Assigns Hoenn Dex Pokémon (Using National Dex Index)
{
    ...
    HOENN_TO_NATIONAL(ORANGE_BUTTERFREE),
    HOENN_TO_NATIONAL(ORANGE_VILEPLUME),
    HOENN_TO_NATIONAL(ORANGE_BELLSPROUT),
    HOENN_TO_NATIONAL(ORANGE_WEEPINBELL),
    HOENN_TO_NATIONAL(ORANGE_VICTREEBEL),
    HOENN_TO_NATIONAL(ORANGE_ONIX),
    HOENN_TO_NATIONAL(ORANGE_GYARADOS),
    HOENN_TO_NATIONAL(ORANGE_SENTRET),
    HOENN_TO_NATIONAL(ORANGE_FURRET),
    HOENN_TO_NATIONAL(ORANGE_HOOTHOOT),
    HOENN_TO_NATIONAL(ORANGE_NOCTOWL),
	HOENN_TO_NATIONAL(ORANGE_BELLOSSOM),
    HOENN_TO_NATIONAL(ORANGE_GIRAFARIG),
    HOENN_TO_NATIONAL(ORANGE_DUNSPARCE),
    HOENN_TO_NATIONAL(ORANGE_STEELIX),
    HOENN_TO_NATIONAL(ORANGE_WINGULL),
    HOENN_TO_NATIONAL(ORANGE_PELIPPER),
    HOENN_TO_NATIONAL(ORANGE_VOLBEAT),
    HOENN_TO_NATIONAL(ORANGE_ILLUMISE),
    HOENN_TO_NATIONAL(ORANGE_TORKOAL),
    HOENN_TO_NATIONAL(ORANGE_TROPIUS),
    HOENN_TO_NATIONAL(ORANGE_ABSOL),
    HOENN_TO_NATIONAL(WEAK_LAPRAS),
};
...
static const u8 sMonFrontAnimIdsTable[] =
{
    ...
    [SPECIES_ORANGE_BUTTERFREE - 1] = 0x1d,
    [SPECIES_ORANGE_VILEPLUME - 1] = 0x49,
    [SPECIES_ORANGE_BELLSPROUT - 1] = 0x17,
    [SPECIES_ORANGE_WEEPINBELL - 1] = 0x0d,
    [SPECIES_ORANGE_VICTREEBEL - 1] = 0x32,
	[SPECIES_ORANGE_GYARADOS - 1] = 0x48,
    [SPECIES_ORANGE_SENTRET - 1] = 0x00,
    [SPECIES_ORANGE_FURRET - 1] = 0x32,
    [SPECIES_ORANGE_HOOTHOOT - 1] = 0x47,
    [SPECIES_ORANGE_NOCTOWL - 1] = 0x17,
	[SPECIES_ORANGE_BELLOSSOM - 1] = 0x0b,
    [SPECIES_ORANGE_WINGULL - 1] = 0x1b,
    [SPECIES_ORANGE_PELIPPER - 1] = 0x1c,
    [SPECIES_WEAK_LAPRAS - 1] = 0x17,
};
...
static const u8 sMonAnimationDelayTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_ORANGE_WEEPINBELL - 1] = 0x03,
};
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    if (ShouldGetStatBadgeBoost(FLAG_BADGE05_GET, battlerIdAtk))
        attack = (110 * attack) / 100;
    if (ShouldGetStatBadgeBoost(FLAG_BADGE07_GET, battlerIdDef))
        defense = (110 * defense) / 100;
    if (ShouldGetStatBadgeBoost(FLAG_BADGE04_GET, battlerIdAtk))
        spAttack = (110 * spAttack) / 100;
    if (ShouldGetStatBadgeBoost(FLAG_BADGE04_GET, battlerIdDef))
...
u16 CorrectNumberForForm(u16 dexNum)
{
    if(!IsNationalPokedexEnabled())
    {
        switch(dexNum)
        {
        case HOENN_DEX_BUTTERFREE:
            return HOENN_DEX_ORANGE_BUTTERFREE;
        case HOENN_DEX_VILEPLUME:
            return HOENN_DEX_ORANGE_VILEPLUME;
        case HOENN_DEX_BELLSPROUT:
            return HOENN_DEX_ORANGE_BELLSPROUT;
        case HOENN_DEX_WEEPINBELL:
            return HOENN_DEX_ORANGE_WEEPINBELL;
        case HOENN_DEX_VICTREEBEL:
            return HOENN_DEX_ORANGE_VICTREEBEL;
        case HOENN_DEX_ONIX:
            return HOENN_DEX_ORANGE_ONIX;
        case HOENN_DEX_GYARADOS:
            return HOENN_DEX_ORANGE_GYARADOS;
        case HOENN_DEX_SENTRET:
            return HOENN_DEX_ORANGE_SENTRET;
        case HOENN_DEX_FURRET:
            return HOENN_DEX_ORANGE_FURRET;
        case HOENN_DEX_HOOTHOOT:
            return HOENN_DEX_ORANGE_HOOTHOOT;
        case HOENN_DEX_NOCTOWL:
            return HOENN_DEX_ORANGE_NOCTOWL;
        case HOENN_DEX_BELLOSSOM:
            return HOENN_DEX_ORANGE_BELLOSSOM;
        case HOENN_DEX_GIRAFARIG:
            return HOENN_DEX_ORANGE_GIRAFARIG;
        case HOENN_DEX_DUNSPARCE:
            return HOENN_DEX_ORANGE_DUNSPARCE;
        case HOENN_DEX_STEELIX:
            return HOENN_DEX_ORANGE_STEELIX;
        case HOENN_DEX_WINGULL:
            return HOENN_DEX_ORANGE_WINGULL;
        case HOENN_DEX_PELIPPER:
            return HOENN_DEX_ORANGE_PELIPPER;
        case HOENN_DEX_VOLBEAT:
            return HOENN_DEX_ORANGE_VOLBEAT;
        case HOENN_DEX_ILLUMISE:
            return HOENN_DEX_ORANGE_ILLUMISE;
        case HOENN_DEX_TORKOAL:
            return HOENN_DEX_ORANGE_TORKOAL;
        case HOENN_DEX_TROPIUS:
            return HOENN_DEX_ORANGE_TROPIUS;
        case HOENN_DEX_ABSOL:
            return HOENN_DEX_ORANGE_ABSOL;
        case HOENN_DEX_LAPRAS:
            return HOENN_DEX_WEAK_LAPRAS;
        default:
            return dexNum;   
        }
    }
    else
    {
        switch(dexNum)
        {
        case NATIONAL_DEX_ORANGE_BUTTERFREE:
            return NATIONAL_DEX_BUTTERFREE;
        case NATIONAL_DEX_ORANGE_VILEPLUME:
            return NATIONAL_DEX_VILEPLUME;
        case NATIONAL_DEX_ORANGE_BELLSPROUT:
            return NATIONAL_DEX_BELLSPROUT;
        case NATIONAL_DEX_ORANGE_WEEPINBELL:
            return NATIONAL_DEX_WEEPINBELL;
        case NATIONAL_DEX_ORANGE_VICTREEBEL:
            return NATIONAL_DEX_VICTREEBEL;
        case NATIONAL_DEX_ORANGE_ONIX:
            return NATIONAL_DEX_ONIX;
        case NATIONAL_DEX_ORANGE_GYARADOS:
            return NATIONAL_DEX_GYARADOS;
        case NATIONAL_DEX_ORANGE_SENTRET:
            return NATIONAL_DEX_SENTRET;
        case NATIONAL_DEX_ORANGE_FURRET:
            return NATIONAL_DEX_FURRET;
        case NATIONAL_DEX_ORANGE_HOOTHOOT:
            return NATIONAL_DEX_HOOTHOOT;
        case NATIONAL_DEX_ORANGE_NOCTOWL:
            return NATIONAL_DEX_NOCTOWL;
        case NATIONAL_DEX_ORANGE_BELLOSSOM:
            return NATIONAL_DEX_BELLOSSOM;
        case NATIONAL_DEX_ORANGE_GIRAFARIG:
            return NATIONAL_DEX_GIRAFARIG;
        case NATIONAL_DEX_ORANGE_DUNSPARCE:
            return NATIONAL_DEX_DUNSPARCE;
        case NATIONAL_DEX_ORANGE_STEELIX:
            return NATIONAL_DEX_STEELIX;
        case NATIONAL_DEX_ORANGE_WINGULL:
            return NATIONAL_DEX_WINGULL;
        case NATIONAL_DEX_ORANGE_PELIPPER:
            return NATIONAL_DEX_PELIPPER;
        case NATIONAL_DEX_ORANGE_VOLBEAT:
            return NATIONAL_DEX_VOLBEAT;
        case NATIONAL_DEX_ORANGE_ILLUMISE:
            return NATIONAL_DEX_ILLUMISE;
        case NATIONAL_DEX_ORANGE_TORKOAL:
            return NATIONAL_DEX_TORKOAL;
        case NATIONAL_DEX_ORANGE_TROPIUS:
            return NATIONAL_DEX_TROPIUS;
        case NATIONAL_DEX_ORANGE_ABSOL:
            return NATIONAL_DEX_ABSOL;
        case NATIONAL_DEX_WEAK_LAPRAS:
            return NATIONAL_DEX_LAPRAS;
        default:
            return dexNum;   
        }
    } 
...
u16 SpeciesToPokedexNum(u16 species)
{
    if (IsNationalPokedexEnabled())
    {
        return CorrectNumberForForm(SpeciesToNationalPokedexNum(species));
    }
    else
    {
        species = CorrectNumberForForm(SpeciesToHoennPokedexNum(species));
...
u16 GetBattleBGM(void)
{
    if (gBattleTypeFlags & BATTLE_TYPE_KYOGRE_GROUDON)
        ...
        return MUS_ORANGE_TRAINER_BATTLE;

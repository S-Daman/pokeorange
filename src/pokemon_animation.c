...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_ORANGE_BUTTERFREE] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_ORANGE_VILEPLUME] = BACK_ANIM_SHRINK_GROW_2,
    [SPECIES_ORANGE_BELLSPROUT] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_ORANGE_WEEPINBELL] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_ORANGE_VICTREEBEL] = BACK_ANIM_VERTICAL_STRETCH,
	[SPECIES_ORANGE_GYARADOS] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_ORANGE_SENTRET] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_ORANGE_FURRET] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_ORANGE_HOOTHOOT] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_ORANGE_NOCTOWL] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
	[SPECIES_ORANGE_BELLOSSOM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_ORANGE_WINGULL] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_ORANGE_PELIPPER] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_WEAK_LAPRAS] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
	[SPECIES_ORANGE_ONIX] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
	[SPECIES_ORANGE_STEELIX] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
};

...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_ORANGE_BUTTERFREE] = gMonIcon_OrangeButterfree,
    [SPECIES_ORANGE_VILEPLUME] = gMonIcon_OrangeVileplume,
    [SPECIES_ORANGE_BELLSPROUT] = gMonIcon_OrangeBellsprout,
    [SPECIES_ORANGE_WEEPINBELL] = gMonIcon_OrangeWeepinbell,
    [SPECIES_ORANGE_VICTREEBEL] = gMonIcon_OrangeVictreebel,
	[SPECIES_ORANGE_GYARADOS] = gMonIcon_OrangeGyarados,
    [SPECIES_ORANGE_SENTRET] = gMonIcon_OrangeSentret,
    [SPECIES_ORANGE_FURRET] = gMonIcon_OrangeFurret,
    [SPECIES_ORANGE_HOOTHOOT] = gMonIcon_OrangeHoothoot,
    [SPECIES_ORANGE_NOCTOWL] = gMonIcon_OrangeNoctowl,
	[SPECIES_ORANGE_BELLOSSOM] = gMonIcon_OrangeBellossom,
    [SPECIES_ORANGE_WINGULL] = gMonIcon_OrangeWingull,
    [SPECIES_ORANGE_PELIPPER] = gMonIcon_OrangePelipper,
    [SPECIES_WEAK_LAPRAS] = gMonIcon_Lapras,
	[SPECIES_ORANGE_ONIX] = gMonIcon_OrangeOnix,
	[SPECIES_ORANGE_STEELIX] = gMonIcon_OrangeSteelix,
};
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_ORANGE_BUTTERFREE] = 0,
    [SPECIES_ORANGE_VILEPLUME] = 0,
    [SPECIES_ORANGE_BELLSPROUT] = 1,
    [SPECIES_ORANGE_WEEPINBELL] = 1,
    [SPECIES_ORANGE_VICTREEBEL] = 1,
	[SPECIES_ORANGE_GYARADOS] = 0,
    [SPECIES_ORANGE_SENTRET] = 2,
    [SPECIES_ORANGE_FURRET] = 2,
    [SPECIES_ORANGE_HOOTHOOT] = 2,
    [SPECIES_ORANGE_NOCTOWL] = 2,
	[SPECIES_ORANGE_BELLOSSOM] = 1,
    [SPECIES_ORANGE_WINGULL] = 0,
    [SPECIES_ORANGE_PELIPPER] = 0,
    [SPECIES_WEAK_LAPRAS] = 2,
    [SPECIES_ORANGE_ONIX] = 0,
	[SPECIES_ORANGE_STEELIX] = 0,
};

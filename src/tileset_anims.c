...
static void TilesetAnim_gTileset_Rustboro2(u16);
...
static void QueueAnimTiles_Petalburg_Whirlpool(u16);
static void QueueAnimTiles_gTileset_Rustboro2_Whirlpool(u16);
...
const u16 gTilesetAnims_Petalburg_Whirlpool_Frame0[] = INCBIN_U16("data/tilesets/secondary/petalburg/anim/Whirlpool/0.4bpp");
const u16 gTilesetAnims_Petalburg_Whirlpool_Frame1[] = INCBIN_U16("data/tilesets/secondary/petalburg/anim/Whirlpool/1.4bpp");
const u16 gTilesetAnims_Petalburg_Whirlpool_Frame2[] = INCBIN_U16("data/tilesets/secondary/petalburg/anim/Whirlpool/2.4bpp");
const u16 gTilesetAnims_Petalburg_Whirlpool_Frame3[] = INCBIN_U16("data/tilesets/secondary/petalburg/anim/Whirlpool/3.4bpp");

const u16 *const gTilesetAnims_Petalburg_Whirlpool[] = {
    gTilesetAnims_Petalburg_Whirlpool_Frame0,
    gTilesetAnims_Petalburg_Whirlpool_Frame1,
    gTilesetAnims_Petalburg_Whirlpool_Frame2,
    gTilesetAnims_Petalburg_Whirlpool_Frame3
};

const u16 gTilesetAnims_gTileset_Rustboro2_Whirlpool_Frame0[] = INCBIN_U16("data/tilesets/secondary/gTileset_Rustboro2/anim/Whirlpool/0.4bpp");
const u16 gTilesetAnims_gTileset_Rustboro2_Whirlpool_Frame1[] = INCBIN_U16("data/tilesets/secondary/gTileset_Rustboro2/anim/Whirlpool/1.4bpp");
const u16 gTilesetAnims_gTileset_Rustboro2_Whirlpool_Frame2[] = INCBIN_U16("data/tilesets/secondary/gTileset_Rustboro2/anim/Whirlpool/2.4bpp");
const u16 gTilesetAnims_gTileset_Rustboro2_Whirlpool_Frame3[] = INCBIN_U16("data/tilesets/secondary/gTileset_Rustboro2/anim/Whirlpool/3.4bpp");

const u16 *const gTilesetAnims_gTileset_Rustboro2_Whirlpool[] = {
    gTilesetAnims_gTileset_Rustboro2_Whirlpool_Frame0,
    gTilesetAnims_gTileset_Rustboro2_Whirlpool_Frame1,
    gTilesetAnims_gTileset_Rustboro2_Whirlpool_Frame2,
    gTilesetAnims_gTileset_Rustboro2_Whirlpool_Frame3
};
...
void InitTilesetAnim_gTileset_Rustboro2(void)
{
    sSecondaryTilesetAnimCounter = 0;
    sSecondaryTilesetAnimCounterMax = sPrimaryTilesetAnimCounterMax;
    sSecondaryTilesetAnimCallback = TilesetAnim_gTileset_Rustboro2;
}
...
{
    if (timer % 16 == 0)
		QueueAnimTiles_Petalburg_Whirlpool(timer >> 4);
}

static void TilesetAnim_gTileset_Rustboro2(u16 timer)
{
    if (timer % 16 == 0)
		QueueAnimTiles_gTileset_Rustboro2_Whirlpool(timer >> 4);
}
